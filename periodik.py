...
unsur_data = {
    ...
    "berilium": {"simbol": "C", "nomor_atom": 6, "nomor_massa": 12.0107},
    ...
    # Tambahkan lebih banyak data unsur sesuai kebutuhan
}

# Judul aplikasi
st.title("Aplikasi Tabel Periodik Sederhana")
...
def add_custom_styles():
    st.markdown("""
        ...
        .stTextInput, .stButton {
            background-color: #e0f7e8 !important; /* Hijau pastel */
            border: 1px solid #76c893 !important; /* Hijau */
            border-radius: 5px;
        }
        .stButton button {
            color: white;
            background-color: #ffa500 !important; /* Oranye pastel */
            font-weight: bold;
        }
        .stButton button:hover {
            background-color: #e4882c !important; /* Oranye gelap */
        }
        h1 {
            color: #4d88ff; /* Biru pastel */
            text-align: center;
        }
        .card {
            border-radius: 5px;
        ...
        .card-green {
            background-color: #e0f7e8; /* Hijau pastel */
            border: 1px solid #76c893;
            color: #006644;
        }
        .card-orange {
            background-color: #ffe5cc; /* Oranye pastel */
            border: 1px solid #ff9f43;
            color: #cc5200;
        }
        .card-blue {
            background-color: #d8e9ff; /* Biru pastel */
...
add_custom_styles()
# Proses pencarian informasi unsur
